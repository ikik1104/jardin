...
public class DataController {
	...
	public Map<String, Object> dataList() throws Exception{
		//url로 파라미터로 데이터를 넘기는거
		StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/1360000/TourStnInfoService/getTourStnVilageFcst"); /*URL*/
        urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=yQITAIaz3aEywpLg2hAtyhMDvLIKMxH%2F0SIY8D8tP%2FGg90feof7qzqSLVQkziapI%2B85sWR8WB6Unm3lUHyK7UA%3D%3D"); /*Service Key*/
        ...
        for (int i = 0; i < array.size(); i++) {
        	...
        	String spotAreaName = (String) arr.get("spotAreaName");
