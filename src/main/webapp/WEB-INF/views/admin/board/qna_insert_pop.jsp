...
<html>
	<head>
		...
		function submit_form() {
			var qu_num = $("#qu_num").val();
	    	var qa_content = $("#qa_content").val();
	    	var form1 = [qu_num,qa_content];
	    	
	    	$.ajax({
			      type : "POST",
			      url : "qna_answer_insert",
			      dataType : "json",
			...
			<form name="inputform" method="post">
				<div id="input_form">
					<table border="1">
						<tr>
							<td>질문 내용</td>
							<td>${dto.qu_content}</td>
						</tr>
						<tr>
							<td>질문 답변</td>
							<td><textarea name="qa_content" id="qa_content" maxlength="200"></textarea></td>
						</tr>
					</table>
					<div id="btn_div">
						<input type="hidden" name="qu_num" id="qu_num" value="${dto.qu_num}">
