...
<html>
	<head>
		...
		function submit_form() {
	    	...
	    	var form1 = [qa_num,qa_content];
	    	
	    	$.ajax({
			      type : "POST",
			      url : "qna_answer_update",
			      dataType : "json",
			...
			<form name="inputform" method="post">
				<div id="input_form">
					<table border="1">
						...
						<tr>
							<td>질문 답변</td>
							<td><textarea name="qa_content" id="qa_content" maxlength="200">${dto.QA_CONTENT}</textarea></td>
						</tr>
					</table>
					<div id="btn_div">
						<input type="hidden" name="qu_num" id="qa_num" value="${dto.QA_NUM}">
