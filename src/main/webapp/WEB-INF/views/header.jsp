			...
			<ul>
				...
				<li class="t1"><a href="u_product_list?step1='브랜드관'" id="topNavi7">브랜드관</a>
					<ul id="topSubm6">
						...
						<li><a href="u_product_list?step2='드롭탑'">드롭탑</a></li>
						<li><a href="u_product_list?step2='요거프레소'">요거프레소</a></li>
					</ul>
				</li>
				<li class="t2"><a href="u_product_list?step2='대량구메'" id="topNavi8">용품</a>
					<ul id="topSubm6">
						<li><a href="u_product_list?step2='커피용품'">커피용품</a></li>
					</ul>
				</li>
			</ul>
		</div>
