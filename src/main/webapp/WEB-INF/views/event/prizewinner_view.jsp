				...
				<div id="mypage">
					...
					<div class="viewDivMt">
						<div class="viewHead">
							<div class="subject">
								<ul>
									<li>${win_info.winboarddto.wb_title }</li>
								</ul>
							</div>
							<div class="data">
								<ul>
									<li>등록일<span>${win_info.utildto.str1 }</span></li>
									<li>조회수<span>${win_info.winboarddto.wb_hit }</span></li>
								</ul>
							</div>
						</div>
...
${win_info.winboarddto.wb_content }							
							</pre>
						</div>
					</div>
