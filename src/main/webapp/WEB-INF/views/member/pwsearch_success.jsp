		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="member">
					...
					<p style="font-size:18px; text-align:center; margin-bottom: 50px; margin-top: 50px;"> 입력하신 이메일로 임시비밀번호를 발송했습니다. 이메일을 확인한 후 로그인 해주세요. </p>
					<div class="btn_area" style="text-align: center;">
						<button onclick="location.href='main'">메인으로</button><button onclick="location.href='idsearch'">아이디 찾기</button>
					</div>
