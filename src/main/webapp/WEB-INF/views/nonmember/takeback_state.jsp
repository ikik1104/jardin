                                    ...
                                    <c:forEach var="rtrf" items="${ rtrflist }">
                                        <tr>
                                            <td>
                                                ...
                                                <a href="non_order_statement?ol_order_num=${ rtrf.OL_ORDER_NUM }"><p class="orderNum">${ rtrf.OL_ORDER_NUM }</p></a>
                                            </td>
                                            <td class="tnone"><span class="heavygray">${ rtrf.RT_SORT }</span></td>
                                            <td class="left">
                                                ${ rtrf.P_NAME }
                                            </td>
                                            <td class="tnone">${ rtrf.RT_PRICE } 원</td>
                                            <td><span class="orange">${ rtrf.RT_STATUS }</span></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
