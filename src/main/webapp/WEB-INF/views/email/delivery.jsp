...
<tr>
	<td style="width:700px;height:78px;padding:0;margin:0;vertical-align:top;">
		<p style="width:620px;margin:50px 0 0 38px;text-align:center;font-size:0;line-height:0;"><img src="user/images/email/img_txt_delivery01.jpg" alt="원두커피의 名家, JARDIN 제품이 발송 완료되었습니다." /></p>
	</td>
</tr>
<tr>
	<td style="width:700px;padding:0;margin:0;vertical-align:top;">
		...
		<p style="width:620px;margin:10px 0 50px 38px;text-align:center;font-size:12px;line-height:1;color:#888888;">회원님께서 구매하신 물품을 발송해 드렸습니다.</p>
	</td>
</tr>
<tr>
	<td style="width:700px;height:40px;line-height:40px;padding:0;margin:0;vertical-align:top;background:#d9d9d9;text-align:center;color:#666;">
		발송일 : 2014.04.11 / 택배 송장번호 추적 : <strong style="color:#444;">한진택배(502204662116)</strong>
	</td>
</tr>
<tr>
	<td style="width:700px;padding:0;margin:0;vertical-align:top;">
